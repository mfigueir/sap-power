...
[![GitHub release](https://img.shields.io/github/v/release/mfigueir/sap-power)](https://github.com/mfigueir/sap-power/releases)
...
2. Copy the `sap-power` folder to your Kiro powers directory:
