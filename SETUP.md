# Setup Guide for SAP Power for Kiro

This guide walks you through setting up the SAP Power for Kiro in Kiro IDE and preparing your environment for SAP development.
...
git clone https://github.com/YOUR_USERNAME/sap-power.git sap-power
...
3. Copy the `sap-power` folder to:
...
4. Verify "SAP Power" appears in the list
...
Edit `~/.kiro/powers/sap-power/POWER.md` to add custom file patterns:
...
```bash
# macOS/Linux
ls -la ~/.kiro/powers/sap-power

# Windows
dir %USERPROFILE%\.kiro\powers\sap-power
```

**Verify POWER.md exists:**
```bash
cat ~/.kiro/powers/sap-power/POWER.md
```
...
3. **Join the community:**
   ...
   - [GitHub Discussions](https://github.com/YOUR_USERNAME/sap-power/discussions)

## Support

- **Documentation**: [README.md](README.md)
- **Issues**: [GitHub Issues](https://github.com/mfigueir/sap-power/issues)
- **Discussions**: [GitHub Discussions](https://github.com/mfigueir/sap-power/discussions)
...
**Ready to start developing with SAP Power for Kiro!** 🚀
